...
;            Learn how to calculate the day of the week
;
...
start:      LD   SP,1000h       ; establish local stack
            ...
            CALL calcDOW        ; determine day of week
            LD   HL,stDate 
            CALL putStr         ; "The date is "
...
; pDate: print the date as month/day/year
;
pDate:      LD   A,(mon)        ; months 0-11
            INC  A              ; conv to months 1-12
            DAA                 ; adjust for BCD math
            ...
            CALL putCh 
            LD   A,(year)
            SUB  0A0h           ; change baseyear 1900 to 2000
...
year:       .dw 0000
dow:        .db 00
stDate:     .db "The current date is ",0
